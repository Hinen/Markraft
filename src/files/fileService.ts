...
export interface DocumentFile { path: string; name: string; text: string; encoding: 'UTF-8' | 'UTF-8 BOM' | 'UTF-16 LE' | 'UTF-16 BE'; lineEnding: 'LF' | 'CRLF'; revision: string }
export interface SaveRequest { path: string | null; text: string; encoding: DocumentFile['encoding']; lineEnding: DocumentFile['lineEnding']; revision: string | null; saveAs: boolean; suggestedName: string }
export const files = {
